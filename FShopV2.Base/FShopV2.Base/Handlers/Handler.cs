...
namespace FShopV2.Base.Handlers
{
    public class Handler : IHandler
    {
        ...
        private Func<FShopV2Exception, Task> _onCustomError;
        ...
        public IHandler OnCustomError(Func<FShopV2Exception, Task> onCustomError, bool rethrow = false)
        {
        ...
        public async Task ExecuteAsync()
        {
            ...
            catch (FShopV2Exception customException)
            {
                isFailure = true;
