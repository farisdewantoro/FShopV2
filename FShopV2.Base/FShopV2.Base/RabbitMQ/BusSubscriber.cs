...
namespace FShopV2.Base.RabbitMQ
{
    public class BusSubscriber : IBusSubscriber
    {
        ...
        private async Task<Acknowledgement> TryHandleAsync<TMessage>(TMessage message,
            ...
            Func<Task> handle, Func<TMessage, FShopV2Exception, IRejectedEvent> onError = null)
        {
            var currentRetry = 0;
            ...
            return await retryPolicy.ExecuteAsync<Acknowledgement>(async () =>
            {
                ...
                using (scope)
                {
                    ...
                    catch (Exception exception)
                    {
                        ...
                        if (exception is FShopV2Exception FShopV2Exception && onError != null)
                        {
                            var rejectedEvent = onError(message, FShopV2Exception);
